<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="aci-user-new.aspx.cs" Inherits="ACI_TMS.aci_user_new" %>
    ...
    <div id="page-wrapper">
        <div class="row text-left">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h3>
                    <asp:Label ID="lbACIStaffDetails" runat="server" Text="ACI Staff Add"></asp:Label>
                </h3>
        ...
        <div class="row text-left">
            ...
            <div class="col-lg-3">
                <asp:Label ID="lblInterviewer" runat="server" Text="Is Interviewer?" Font-Bold="true"></asp:Label>
