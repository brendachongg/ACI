<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="applicant-programme-receipt.aspx.cs" Inherits="ACI_TMS.applicant_programme_receipt" %>
...
<body style="font-size:8pt;margin:50px 50px 0px 50px;background-color:white;">
    <form id="form1" runat="server">
        <div id="page-wrapper">
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td style="border-bottom:1px solid black">
                                <asp:Label ID="lbDisplayWords" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="row text-left">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p>Name: <asp:Label ID="lbApplicantName" runat="server" Text=""></asp:Label> (<asp:Label ID="lbApplicantId" runat="server" Text=""></asp:Label><asp:Label ID="lbTraineeId" runat="server" Text=""></asp:Label>)</p>
                    <p id="pCompany" runat="server" visible="false">Company: <asp:Label ID="lbCompany" runat="server" Text=""></asp:Label></p>
                </div>
            </div>
                    ...
                    <table class="table table-responsive">
                        ...
                        <tbody>
                            <tr id="trReg" runat="server">
                                ...
                                <td class="text-right"><asp:Label ID="lbRegFee" runat="server" Text=""></asp:Label></td>
                            </tr>

                            <tr id="trProg" runat="server">
                                <td>Programme Fee</td>
                                <td class="text-right"><asp:Label ID="lbProgFee" runat="server"></asp:Label></td>
                            </tr>

<%--                            <asp:Repeater ID="rpModules" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;<%# Eval("moduleTitle") %> (<%# Eval("moduleCode") %>)</td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>--%>

                            <tr id="trSubsidy" runat="server">
                                <td>Subsidy: <asp:Label ID="lbSubsidy" runat="server"></asp:Label></td>
                                <td class="text-right"><asp:Label ID="lbSubsidyAmt" runat="server"></asp:Label></td>
                            </tr>
                            ...
                            <tr>
                                <td style="width: 75%;">
                                    ...
                                    <br />
                                    <br />
                                    <b>Amount Paid <asp:Label ID="lbPartialPayment" runat="server" Text="(Partial Payment)"></asp:Label></b>
                                    <br />
