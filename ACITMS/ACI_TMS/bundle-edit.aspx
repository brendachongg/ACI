<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="bundle-edit.aspx.cs" Inherits="ACI_TMS.bundle_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        ...
        <div class="row text-left">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h3>
                    <asp:Label ID="lbBundleCreationHeader" runat="server" Font-Bold="true" Text="Edit Bundle"></asp:Label>
                </h3>
        ...
        <div class="row">
            <div class="col-lg-3">
                <asp:Label ID="lb4" runat="server" Text="Bundle Code" Font-Bold="true"></asp:Label>
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <asp:Label ID="lb8" runat="server" Text="Level" Font-Bold="true"></asp:Label>
                ...
                <div class="col-lg-2">
                    <asp:Label ID="lb9" runat="server" Text="Cost" Font-Bold="true"></asp:Label>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <asp:GridView ID="gvModule" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="bundleModuleId" />
                            ...
                            <asp:BoundField HeaderText="Module Code" DataField="moduleCode" ItemStyle-Width="200px" ReadOnly="True">
                                <ItemStyle Width="200px"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Version" DataField="moduleVersion" ItemStyle-Width="80px" ReadOnly="True">
                                <ItemStyle Width="80px"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Title" DataField="moduleTitle" ReadOnly="True" />
                            <asp:BoundField HeaderText="Effective Date" DataField="moduleEffectDate" ItemStyle-Width="150px" ReadOnly="True">
                                <ItemStyle Width="150px"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Cost" DataField="moduleCost" ItemStyle-Width="100px" ReadOnly="True" />
        ...
        <div class="row text-right">
            <div class="col-lg-12">
                <asp:Button ID="btnSaveBundle" runat="server" CssClass="btn btn-primary" Text="Save" ValidationGroup="bundle" OnClick="btnSaveBundle_Click" />
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#diagReloadBundle">Clear</button>
            </div>
        </div>
    ...
    <div id="diagReloadBundle" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnClearBundle" runat="server" CssClass="btn btn-default" Text="OK" CausesValidation="false" OnClick="btnClearBundle_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
