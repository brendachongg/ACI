<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="reassessment-view.aspx.cs" Inherits="ACI_TMS.reassessment_view" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="row text-right">
            <div class="col-lg-12">
                ...
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#diagDel" id="btnConfRem" runat="server">Remove</button>
            </div>
        </div>
