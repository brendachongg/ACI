<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="trainee-reassessment-edit.aspx.cs" Inherits="ACI_TMS.trainee_reassessment_edit" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="row text-left">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h3>
                    <asp:Label ID="lbReAssessmentHeader" runat="server" Text="Edit Re-Assessment"></asp:Label>
                </h3>
            </div>
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:HiddenField ID="hfOriReassessmentSessionId" runat="server" />
                </div>
            </div>
        </fieldset>
