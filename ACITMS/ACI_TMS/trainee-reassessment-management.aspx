<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="trainee-reassessment-management.aspx.cs" Inherits="ACI_TMS.trainee_reassessment_management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="row text-center">
            <div class="col-lg-12">
                <h2>
                    <asp:Label ID="lbHeader" runat="server" Text="Re-Assessment Management"></asp:Label>
                </h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:GridView ID="gvReAssessment" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true"
                    CssClass="table table-striped table-bordered dataTable no-footer hover gvv" AllowPaging="true" PageSize="10"
                    OnPageIndexChanging="gvReAssessment_PageIndexChanging" OnRowCommand="gvReAssessment_RowCommand">
                    <EmptyDataTemplate>
