...
namespace ACI_TMS
{
    public partial class trainee_reassessment_view : BasePage
    {
        public const string PAGE_NAME = "trainee-reassessment-view.aspx";
        ...
        public trainee_reassessment_view()
            : base(PAGE_NAME, AccessRight_Constance.REASSESSMENT_VIEW, trainee_reassessment_management.PAGE_NAME)
        {
        ...
        {
            Server.Transfer(trainee_reassessment_edit.PAGE_NAME + "?" + trainee_reassessment_edit.TRAINEE_QUERY + "=" + HttpUtility.UrlEncode(lbTraineeId.Text) + "&" + trainee_reassessment_edit.BATCH_QUERY + "=" + HttpUtility.UrlEncode(hfBatchModuleId.Value));
        }
