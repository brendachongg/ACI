<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="trainee-repeat-module-edit.aspx.cs" Inherits="ACI_TMS.trainee_repeat_module_edit" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="row text-left">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h3>
                    <asp:Label ID="lbHeader" runat="server" Text="Edit Repeat Module"></asp:Label>
                </h3>
            </div>
        ...
        <fieldset>
            <legend>Repeat Module Details</legend>
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <asp:HiddenField ID="hfOriModuleId" runat="server" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:HiddenField ID="hfOriBatchId" runat="server" />
                </div>
            </div>
