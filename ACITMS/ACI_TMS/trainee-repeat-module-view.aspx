<%@ Page Title="" Language="C#" MasterPageFile="~/aci-dashboard.Master" AutoEventWireup="true" CodeBehind="trainee-repeat-module-view.aspx.cs" Inherits="ACI_TMS.trainee_repeat_module_view" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="row text-left">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h3>
                    <asp:Label ID="lbHeader" runat="server" Text="View Repeat Module"></asp:Label>
                </h3>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to remove the repeat module?
                </div>
